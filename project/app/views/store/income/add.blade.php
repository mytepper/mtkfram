        ...
        <div class="col-md-12">
         <div class="panel">
              ...
              <div class="panel-body">
                ...
                <form role="form" method="post" action="{{URL::to('store/catalog/add')}}" class="form-horizontal" enctype="multipart/form-data">

                  <div class="form-group">
                    <label class="col-lg-3 control-label" for="inputStandard">ชื่อประเภทสินค้า</label>
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" placeholder="" name="Tname" class="form-control" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
