        ...
        <div class="col-md-12">
         <div class="panel">
              ...
              <div class="panel-body">
                ...
                <form role="form" method="post" action="{{URL::to('store/creditor/add')}}" class="form-horizontal" enctype="multipart/form-data">

                  <div class="form-group">
                    <label class="col-lg-3 control-label" for="inputStandard">ชื่อเจ้าหนี้</label>
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" placeholder="" name="Cname" class="form-control" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" placeholder="" name="Ctel" class="form-control" required>
                      </div>
                    </div>
                  </div>
