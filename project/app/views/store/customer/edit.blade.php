        ...
        <div class="col-md-12">
         <div class="panel">
              ...
              <div class="panel-body">
                ...
                <form role="form" method="post" action="{{URL::to('store/customer/edit')}}" class="form-horizontal" enctype="multipart/form-data">
                  
                  <div class="form-group">
                    <label class="col-lg-3 control-label" for="inputStandard">ชื่อลูกค้า</label>
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" value='{{$rs->CUname}}' placeholder="" name="CUname" class="form-control" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" value='{{$rs->CUtel}}' placeholder="" name="CUtel" class="form-control" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" value='{{$rs->CUaddress}}' placeholder="" name="CUaddress" class="form-control" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <textarea name="CUmap" class="form-control">{{$rs->CUmap}}</textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" value='{{$rs->CUnote}}' placeholder="" name="CUnote" class="form-control" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <input type="hidden" name="CUID" value='{{$rs->CUID}}'>
