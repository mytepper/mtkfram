        ...
        <div class="col-md-12">
         <div class="panel">
              ...
              <div class="panel-body">
                ...
                <form role="form" method="post" action="{{URL::to('store/product/add')}}" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" placeholder="" name="Pname" class="form-control" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" placeholder="" name="Psize" class="form-control" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" placeholder="" name="Punit" class="form-control" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" placeholder="" name="P_buy_i" class="form-control int" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" placeholder="" name="P_buy_f" class="form-control int" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" placeholder="" name="P_price_i" class="form-control int" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="">
                        <input type="text" placeholder="" name="P_price_f" class="form-control int" required>
                      </div>
                    </div>
                  </div>
