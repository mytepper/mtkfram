        ...
        <div class="col-md-12">
         <div class="panel">
              <div class="panel-heading">
                <span class="panel-title">ข้อมูลบิลเงินสด</span>
              </div>
              <div class="panel-body">

                <form role="form" method="post" action="{{URL::to('store/bill/edit')}}" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <button type="button" class="btn add_data_bill btn-success"><i class="fa fa-plus"></i> เพิ่มรายการ</button>
                  </div>
